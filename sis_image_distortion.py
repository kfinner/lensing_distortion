...
parser.add_argument("--mass", dest="mass", action="store", default="none",
                        help="The mass of the galaxy or cluster.")
parser.add_argument("--zsource", dest="zsource", action="store", default="",
                        help="The redshift of the source.")
parser.add_argument("--zlens", dest="zlens", action="store", default="",
...
for i in range(0,500,5):
    input_img = models.Gaussian(0, 100, 1000+i, 1000, 3, 3, 0).get_postage(2001)
